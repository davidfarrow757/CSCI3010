...
//vector<double> MatchVectors(std::vector<double> a, vector<double> b);
...
// returns a vector with true for numbers less than the second parameters and false for those greater than or equal to
//vector<bool> LessMask(std::vector<int> nums, int less_than);
...
//vector<int> AddN(std::vector<int> v, int n)
